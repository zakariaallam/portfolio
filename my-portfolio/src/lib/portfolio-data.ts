export const profileData = {
  ...
  social: {
    github: 'https://github.com/zakariaallam',
    linkdin: 'https://linkedin.com/in/zakaria-allam-/',
    instagram : '#'
  },
}
  ...
  services: [
    {
      ...
      description: 'Building modern, responsive web applications with React, and JavaScript.',
    },
    {
      icon: 'Zap',
  ...
  education: [
    {
      ...
      period: 'Encour',
      description:
        'Studied Development weeb and App .',
    },
    {
      title: 'Bac',
      period: '2018 — 2019',
      description: 'Sience physic.',
    },
  ],
  experience: [
    {
  ...
  projects: [
    {
      ...
      image: 'https://www.lavieeco.com/wp-content/uploads/2024/01/e-Comerce.jpg',
      description: 'Full-stack e-commerce solution with payment integration',
      tech: ['PHP', 'OOP','MVC', 'PostgreSQL'],
      liveUrl: 'https://app-e-commerce-h7za.onrender.com/',
      githubUrl: 'https://github.com/zakariaallam/App-E-commerce',
    },
    // {
...
export const contactData = {
  ...
  mapEmbedUrl:
    'https://maps.app.goo.gl/oV8nk5hifjY1D3bA9',
}
